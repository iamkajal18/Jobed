...
import { faMapMarkerAlt, faDollarSign, faBriefcase, faCalendarAlt, faClock } from '@fortawesome/free-solid-svg-icons';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1 bg-white shadow-lg rounded-lg p-6">
              <div className="flex items-center mb-6">
                ...
                />
                <h4 className="text-xl font-semibold ml-4">{job.company.company_name}</h4>
              </div>
            ...
            <div className="lg:col-span-2 bg-white shadow-lg rounded-lg p-8">
              ...
              <div className="border-b-2 mb-6">
                <button
                  className={`px-4 py-2 text-lg font-medium ${activeTab === 'description' ? 'border-b-2 border-blue-600 text-blue-600' : ''}`}
                  onClick={() => setActiveTab('description')}
                >
                  Job Description
                </button>
                <button
                  className={`px-4 py-2 text-lg font-medium ${activeTab === 'requirements' ? 'border-b-2 border-blue-600 text-blue-600' : ''}`}
              ...
              {activeTab === 'description' ? (
                ...
                <div className="mb-6">
                  <h4 className="text-xl font-semibold mb-2">Job Requirements</h4>
                  <p className="text-gray-600">
                    {job.job_requirement || 'No specific requirements provided.'}
                  </p>
                </div>
              )}
